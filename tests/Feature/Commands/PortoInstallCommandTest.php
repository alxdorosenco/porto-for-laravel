...
use AlxDorosenco\PortoForLaravel\Tests\StructureFilesContent;
...
class PortoInstallCommandTest extends TestCase
{
    ...
    public function provideShip(): array
    {
        return [
            ...
            'Ship/Abstracts/Components/ConsoleCommand.php' => ['Ship/Abstracts/Components/ConsoleCommand.php'],
    ...
    public function testConsoleCommand(): void
    {
        $this->artisan('porto:install')
            ...
            ->expectsOutputToContain('Installing Porto')
            ->expectsOutput("\n")
            ->expectsOutputToContain('Porto structure in the ['.$this->portoPath.'] directory has been successfully installed')
            ->assertSuccessful();
    }
    ...
    public function testExistenceOfTheCreatedShipFilesAndDirectories(string $param): void
    {
        if(str_ends_with($param, '.php')){
            ...
            $this->assertEquals($this->contentShipAbstractsBroadcastingChannel(), $content);
        } else {
